...
public class DBHelper extends SQLiteOpenHelper {
   ...
   public static final String DATABASE_NAME = "speganet.db";
   ...
   public void onCreate(SQLiteDatabase db) {
      ...
      db.execSQL(
         ...
         "(id integer primary key AUTOINCREMENT, fullname text,phonenumber text,country text, countrycode text,logindevice text,emailid text,status text,otp text)"
      );
   }
